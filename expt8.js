...
function bookSeat() {
    ...
    var selectedClass = parseInt(classSelection.value);

    var element = linearSearch(seats, selectedClass);
...
function linearSearch(theArray, input) {
...
function boardingPass(input, element) {

    if (input === 1) {

        document.getElementById("output").innerHTML = "---------- BOARDING PASS --------- <br/>" +

                                                        "You are allocated in the First Class<br/>" +

                                                        "Your seat number is " + element + "<br/> <br/>";
        ...
        document.getElementById("output").innerHTML = "---------- BOARDING PASS --------- <br/>" +
                                                        ...
                                                        "You are allocated in the Economy Class<br/>" +
